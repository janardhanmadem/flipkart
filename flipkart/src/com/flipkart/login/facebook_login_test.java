...
public void facebook_login() throws Throwable{
	...
	try {
		...
		Thread.sleep(2000L);
		driver.findElement(By.xpath(prop.getProperty("facebook_xpath"))).click();
		Thread.sleep(2000L);
		driver.findElement(By.xpath(prop.getProperty("facebook_username"))).sendKeys("exampleapalya@gmail.com");
		driver.findElement(By.xpath(prop.getProperty("facebook_password"))).sendKeys("apalya01");
		driver.findElement(By.xpath(prop.getProperty("facebook_password"))).sendKeys(Keys.ENTER);
		Thread.sleep(3000L);
		...
		FileUtils.copyFile(srcfile, new File("F:\\workspace\\flipkart\\src\\screen_shots\\facebook_login.jpg"));
