...
public class flipkart_login_test {
	...
	public static void login() throws Throwable{
			...
			try {
				...
				Thread.sleep(2000L);
				driver.findElement(By.xpath(prop.getProperty("user_name"))).sendKeys("janardhan.madem@gmail.com");
				driver.findElement(By.xpath(prop.getProperty("password"))).sendKeys("apalya01");
				driver.findElement(By.xpath(prop.getProperty("password"))).sendKeys(Keys.ENTER);
				Thread.sleep(3000L);
				String name=driver.findElement(By.xpath(prop.getProperty("root_node"))).getText();
				System.out.println(name);
				Assert.assertEquals("Hi janardh... !", name);
			...
			FileUtils.copyFile(srcfile, new File("F:\\workspace\\flipkart\\src\\screen_shots\\filpkart_login.jpg"));
